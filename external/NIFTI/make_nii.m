...
function dime = image_dimension(dims, voxel_size, datatype, maxval, minval)
   ...
   case   2
      dime.bitpix = 8;  dime.precision = 'uint8';
   case   4
      dime.bitpix = 16; dime.precision = 'int16';
   case   8
      dime.bitpix = 32; dime.precision = 'int32';
   case  16
      dime.bitpix = 32; dime.precision = 'float32';
   case  64
      dime.bitpix = 64; dime.precision = 'float64';
   case 128
      dime.bitpix = 24;  dime.precision = 'uint8';
   case 256 
      dime.bitpix = 8; dime.precision = 'int8';
   case 511
      dime.bitpix = 96;  dime.precision = 'float32';
   case 512 
      dime.bitpix = 16; dime.precision = 'uint16';
   case 768 
      dime.bitpix = 32; dime.precision = 'uint32';
   otherwise
      error('Datatype is not supported by make_nii.');
   end
