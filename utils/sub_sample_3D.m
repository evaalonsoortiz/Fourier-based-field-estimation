...
% in the center we skip 2 rows because 
vol_lowRes = vol_filt(...
    [phase(1):factor(1):end/2, end/2+factor(1):factor(1):end], ...
    [phase(2):factor(2):end/2, end/2+factor(2):factor(2):end], ...
    [phase(3):factor(3):end/2, end/2+factor(3):factor(3):end]); 
